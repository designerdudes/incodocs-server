...
const mailSend = async (toEmail, subject, text) => {
  ...
  const mailOptions = {
    ...
    <body>
        <table class="m_-5049272237331082851table--wrapper" align="center" cellpadding="0" cellspacing="0" border="0" width="700">
            <tbody>
                <tr>
                    <td align="center" bgcolor="#2E3190" valign="top" style="background-color: #2E3190">
                        <div>
                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 600px" class="m_-5049272237331082851table--content">
                                <tbody>
                                    <tr>
                                        <td align="center" valign="top" style="padding: 30px" class="m_-5049272237331082851logo">
                                            <table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td class="m_-5049272237331082851newLine">
                                                            <a href="https://www.incodocs.com" target="_blank" style="display: flex;flex-wrap: wrap; text-align: center;align-items: center;gap: 16px;width: fit-content;margin: 0 auto;text-decoration: none;" data-saferedirecturl="https://www.incodocs.com">
                                                                <p style="
                                                                    font-family: Helvetica, Arial, sans-serif;
                                                                    height: fit-content;
                                                                    color: #ffffff;
                ...
                <tr>
                    <td align="center" bgcolor="#F6F6F6" valign="top">
                        <div>
                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 600px;margin: -1000px 0" class="m_-5049272237331082851table--content">
                                <tbody>
                                    <tr>
                                        <td bgcolor="#fff" align="left" valign="top" class="m_-5049272237331082851table--content--details" style="border-radius: 4px; padding: 40px; margin: 0 auto">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tbody>
${text}                                                
                                                </tbody>
